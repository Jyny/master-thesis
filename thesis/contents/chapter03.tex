...
此時會談終端 \DEFmeetingbox 應存在純噪音之聲音記錄 \DEFrecN。
    ...
    此協定為初始化會談中的步驟 2\textasciitilde3，其運作細節如圖\ref{fig:protocol-init-create}與說明：
...
此協定為初始化會談中的步驟 4\textasciitilde5，其運作細節如圖\ref{fig:protocol-init-reg}與說明：
...
\subsection{會談主持者授權解封伺服器機制之協定}\label{subsec:protocol-unseal-auth}
    ...
    本章描述之協定為會談生命週期解封會談聲音記錄階段(圖\ref{fig:m-o-unseal})中的步驟 1，
...
\subsection{取得會談聲音記錄機制之協定}
    ...
    本章描述之協定為會談生命週期解封會談聲音記錄階段(圖\ref{fig:m-o-unseal})中的步驟 2，
