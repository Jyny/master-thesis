...
求得結論，當轉換後的純噪音聲音響應輸出 \DEFmicUSD 與 \DEFmicUSJ 的差異越小時，
\DEFmicRecREV 與 \DEFmicConv 的差異也越小。
...
換句話說，我們希望得到一響應輸出系統 \DEFfuncAf{\DEFpause}，
與純超聲波麥克風干擾器的響應輸出系統串連定義為 \DEFfuncAfHT{\DEFpause} $\cdot$ \DEFfuncMicUSN{\DEFpause}，
因而無限趨近於 \DEFfuncMicUSJ{\DEFpause}。
