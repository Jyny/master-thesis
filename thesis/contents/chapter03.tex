...
若 Owner 執行 {\it Challenge} 成功，Server 即透過 Owner 的 Challenge Response 獲得 $EK$ (Unseal Key)，
便可以接續執行 {\it Unseal} 機制中的第二步 {\it ANC}。在 {\it Multi Owner Meeting Session} 的情境中，
則等待所有 Owner 成功執行 {\it Challenge} 之後，Server 得以獲取 $EK$ (Unseal Key)，接續執行 {\it ANC}。
