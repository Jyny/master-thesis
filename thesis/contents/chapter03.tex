...
\begin{pmsgs}
    ...
    透過金鑰分割函數 \DEFfuncSSS{}，根據會談主持者註冊人數 \DEFowreg，分割成 \DEFowreg 份分割秘密。
    再將每個分割秘密，根據每個會談主持者 \DEFowner 的公司私鑰 \DEFpublicKey，
    ...
    隨即銷毀該會談的解封金鑰 \DEFunsealKey 並回覆，訊息內容為空。
...
\subsubsection*{會談主持者授權解封伺服器機制之協定}
