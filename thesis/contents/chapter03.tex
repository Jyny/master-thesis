...
\begin{steps}
    ...
    \item Register Owner：\\
        ...
        並將請求來源 URI 中的 $SID$ 與公開金鑰 $PK_{i}$ 做關聯綁定；
        三、回傳私密金鑰 $SK_{i}$ 給 $Owner_{i}$，且銷毀於 Server 中的$SK_{i}$；即完成此系統步驟。
...
\begin{steps}
    ...
    \item End Owner Registration：\\
        ...
        本研究實驗以錄音指示燈與螢幕為例，當開始錄音時，前述兩者人機互動介面提示將會提示當下系統狀態。
    ...
    \item End Session (Push Button)：\\
        ...
        當錄音已結束時，前述兩者人機互動介面提示將會提示當下系統狀態為 End Session。
