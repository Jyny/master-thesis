...
\begin{longtable}{c l}
    ...
    \showrowcolors
    \DEFattenderAll   & 系統角色會談參與者 \\
    \DEFownerAll      & 系統角色會談擁有者 \\
    \DEFmeetingbox    & 系統角色 MeetingBox \\
    \DEFserver        & 系統角色解封伺服器 \\
    ...
    \DEFakEnc         & 加密保護的的授權金鑰 \DEFagentKey \\
...
\noindent\begin{tabularx}{0.95\textwidth} {
    ...
    \multicolumn{7}{|c|}{} \\
    & \multicolumn{1}{c}{\bf{\DEFowner}} &
    & \multicolumn{1}{c}{\bf{\DEFmeetingbox}} &
    & \multicolumn{1}{c}{\bf{\DEFserver}} & \\
    %
    & \multicolumn{1}{c}{} &
    ...
    $M_2$ $\leftarrow$ $\{$\DEFsessionID, \DEFunsealKey$\}$
    & \\

    & & & &
    $\xleftarrow{ \enskip M_2 \enskip }$
    & & \\

    & & &
    $k$ $\leftarrow$ \DEFunsealKey \newline
    $m_3$ $\leftarrow$ \DEFfuncEncEK{\DEFrecN} \newline
    $M_3$ $\leftarrow$ $\{$\DEFsessionID, $m_3$ $\}$ \newline
    & & & \\

    & & & &
    $\xrightarrow{ \enskip M_3 \enskip }$
    & & \\

    & & & & &
    \DEFrecP $\leftarrow$ $m_3$ \newline
    {\bf Bind Relations:} \newline
    ...
    \pcind \bf{where~} $i=1~...\mid$\DEFownerAll$\mid$:
    & & & & & \\
    ...
    & \multicolumn{1}{|l}{} &
    $\xrightarrow{ \enskip M_{3+2i-1} \enskip }$
    & & & \multicolumn{1}{l|}{} & \\

    & \multicolumn{1}{|l}{} & &
    $M_{3+2i}$ $\leftarrow$ $\{$\DEFsessionID$\}$
    & & \multicolumn{1}{l|}{} & \\

    & \multicolumn{1}{|l}{} &
    $\xleftarrow{ \enskip M_{3+2i} \enskip }$
    & & & \multicolumn{1}{l|}{} & \\

    & \multicolumn{1}{|l}{
    $M_{3+2i+1}$ $\leftarrow$ $\{$\DEFsessionID$\}$
    } & & & & \multicolumn{1}{l|}{} & \\

    & \multicolumn{1}{|l}{} & \multicolumn{3}{c}{
    $\xrightarrow{\qquad M_{3+2i+1} \qquad}$
    }& \multicolumn{1}{l|}{} & \\

    & \multicolumn{1}{|l}{} & & & & \multicolumn{1}{l|}{\shortstack[l]{
    $($\DEFpublicKey, \DEFprivateKey$)$ $\leftarrow$ \DEFfuncKgen{} \\
    ...
    $M_{3+2i+2}$ $\leftarrow$ $\{$\DEFownerID, \DEFprivateKey$\}$
    }} & \\

    & \multicolumn{1}{|l}{} & \multicolumn{3}{c}{
    $\xleftarrow{\qquad M_{3+2i+2} \qquad}$
    }& \multicolumn{1}{l|}{} & \\

    & \multicolumn{1}{|l}{
    \bf{Store~} $\{$\DEFownerID, \DEFprivateKey$\}$
    } & & & & \multicolumn{1}{l|}{
...
\captionof{figure}{Initialize {\it Meeting Session}}\label{fig:protocol-init}
...
\noindent\begin{tabularx}{0.95\textwidth} {
    ...
    \pcind \bf{for each~} $s_{i} \in [s_{i}]$~ \bf{where~} $i=1~...$\DEFowreg: \newline
    ...
    &
    $M_3$ $\leftarrow$ $\{$\DEFsessionID, \DEFrecJ$\}$
    & & & \\
...
\end{tabularx}
\normalsize\end{center}
\captionof{figure}{Running {\it Meeting Session}}\label{fig:protocol-sessioning}
