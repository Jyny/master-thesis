...
\noindent\begin{tabularx}{0.95\textwidth} {
    ...
    & \multicolumn{1}{:l}{
    \pcind\pcind $M_{3}$ $\leftarrow$ $\{$\DEFsessionID$\}$
    } & & & & \multicolumn{1}{l:}{} & \\

    & \multicolumn{1}{:l}{} & \multicolumn{3}{c}{
    $\xrightarrow{\qquad\qquad\qquad\qquad\qquad M_{3} \qquad\qquad\qquad\qquad\qquad}$
    }& \multicolumn{1}{l:}{} & \\
    ...
    $M_{4}$ $\leftarrow$ $\{$\DEFownerID, \DEFprivateKey$\}$
    }} & \\

    & \multicolumn{1}{:l}{} & \multicolumn{3}{c}{
    $\xleftarrow{\qquad\qquad\qquad\qquad\qquad M_{4} \qquad\qquad\qquad\qquad\qquad}$
    }& \multicolumn{1}{l:}{} & \\
...
\noindent\begin{tabularx}{0.95\textwidth} {
    ...
    & \multicolumn{1}{:l}{
    \pcind\pcind $M_{1}$ $\leftarrow$ $\{$\DEFsessionID, \DEFownerID$\}$
    } & & \multicolumn{1}{l:}{} & \\
    ...
    & \multicolumn{1}{:l}{} & & \multicolumn{1}{l:}{
    $M_{2}$ $\leftarrow$ $\{$\DEFownerID, \DEFakEnc$\}$
    } & \\
    ...
    \pcind\pcind $M_{3}$ $\leftarrow$ $\{m_{3}, ~m_{3}.sig\}$
    }} & & \multicolumn{1}{l:}{} & \\
    ...
    &
    $M_{5}$ $\leftarrow$ $\{$\DEFsessionID$\}$
    & & & \\

    & &
    $\xrightarrow{ \qquad M_{5} \qquad }$
    & & \\
    ...
    $M_{6}$ $\leftarrow$ $\{$\DEFsessionID,\DEFrecREV$\}$
    & \\

    & \multicolumn{1}{:l}{} &
    $\xleftarrow{ \qquad M_{6} \qquad }$
    & \multicolumn{1}{l:}{} & \\
